...
hist selected_probes,  freq bin(20) scheme(s1mono) 
	...
	; #delimit cr
graph export  "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/BootstrapProbeNumHist.pdf", replace
...
hist lambda_min,  freq bin(20) scheme(s1mono) 
	...
	name(lambda, replace)
	; #delimit cr	
graph export "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/BootstrapLambdaHist.pdf", replace
...
hist testing_cor,  freq bin(20) scheme(s1mono) 
	...
	; #delimit cr	
graph export "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/BootstrapFitHist.pdf", replace
...
scatter testing_cor  selected_probes, scheme(s1mono) mcolor(blue%30)
	...
	; #delimit cr
graph export "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/Fit_by_ProbeNum.pdf", replace
...
scatter selected_probes lambda_min, scheme(s1mono) mcolor(blue%30)
	...
	; #delimit cr	
graph export "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/Lamda_by_ProbeNum.pdf", replace
...
keep if U == 1
drop U
save "/Users/db3275/Box/Belsky/mPoA/Documentation/CodeToPrepareData/Dunedin_mpoabootsrap_Corr_a.dta", replace
*/
use "/Users/db3275/Box/Belsky/mPoA/Documentation/CodeToPrepareData/Dunedin_mpoabootsrap_Corr_a.dta", clear
...
twoway kdensity r , bwidth(.01) scheme(s1mono) kerne(gaus)
	...
	; #delimit cr
restore
graph export "/Users/db3275/Box/Belsky/mPoA/Documentation/Figures/Bootstrap_ePoA_intercorr.pdf", replace

//Combined Figure
graph combine lambda num_probes bootstrapmpoa_r testcor , scheme(s1mono) altshrink name(epoaboot, replace)
graph export "/Users/db3275/Box/Belsky/mPoA/eLife/Figures/F1SF1.pdf", replace
