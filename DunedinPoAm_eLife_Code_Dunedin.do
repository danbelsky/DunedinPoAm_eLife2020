...
mean gpdom* d_gpdom
	...
	//Place Holders for Retinal Vessel Data (not available at time analysis finalized)
gen A45=invnorm(uniform())
gen V45=invnorm(uniform())
gen D_A=invnorm(uniform())
gen D_V=invnorm(uniform())
...
//Summary Statistics
//****************************************************************************************//
global DPHENO "DB DG d_gpdom DL Diq D_A D_V iPoor DF" 
...
matrix Fx = J(1,4,999)
foreach y in zDB zDG zd_gpdom zDL Diq zD_A zD_V DF { 
	mean `y' if mpoa!=.
...
//******************************************************************************************//
//Export PDF
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/F1SF2.pdf", replace	
//******************************************************************************************//


//******************************************************************************************//
//F1SF3. Comparison of mPoA & Pace of Aging Effect-Sizes
//******************************************************************************************//
...
//******************************************************************************************//
//Export PDF
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/F1SF3.pdf", replace	
//******************************************************************************************//


//****************************************************************************************//
//FIGURE 1SF4. Comparison of Change Score Effect-sizes between DunedinPoAm & Epigenetic Clocks
//****************************************************************************************//
...
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/F1SF4a.pdf", replace


//******************************************************************************************//
//Figure2A. mPoA Effect-Sizes for Age 45 Levels
//******************************************************************************************//
...
twoway bar r Pheno if X==2 & inlist(Pheno,1,2,3,4,5,6,7), horiz color(dknavy)
	...
	legend(off)
	title(A., size(large) color(black) justification(left) span bexpand)
	; #delimit cr
restore
//******************************************************************************************//
//Export PDF
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/Figure2A.pdf", replace	
//******************************************************************************************//


	
//******************************************************************************************//
//Figure2B. mPoA Effect-Sizes for Change Scores
//******************************************************************************************//
global user db3275
use "/Users/$user/Box/Belsky/mPoA/eLife/R1/mPoAR1_Dunedin.dta", clear	
...
title(B., size(large) color(black) justification(left) span bexpand)
; #delimit cr
	//Export PDF
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/Figure2B.pdf", replace	
//******************************************************************************************//
...
//****************************************************************************************//
//****************************************************************************************//
//FIGURE 2 SF1. Comparison of Effect-sizes between DunedinPoAm & Epigenetic Clocks
//****************************************************************************************//
clear
svmat2 Fx_mpoa, names(col) rnames(DV)
gen X = 1 
...
//****************************************************************************************//
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/F2SF1.pdf", replace	
//****************************************************************************************//
//****************************************************************************************//
...
//****************************************************************************************//
//FIGURE 2 SF2. Comparison of Change Score Effect-sizes between DunedinPoAm & Epigenetic Clocks
//****************************************************************************************//
clear
...
#delimit ; 
	twoway scatter X r if X == 1, msize(large) mcolor(midblue)
		...
		by(Pheno, xrescale plotregion(color(white)) graphregion(color(white)) note("") cols(2) holes(6)
			legend(off) 
			) 
	ylabel( 1 "DunedinPoAm" 2 "Horvath Clock" 3 "Hannum Clock" 4 "Levine Clock", nogrid angle(horiz) labsize(medsmall)) 
	yscale(reverse)
	ytitle("")
/*	legend(pos(3) cols(1) order(1 2 3 4) region(lcolor(white))  
		lab(1 "DunedinPoAm") lab(2 "Horvath Clock") lab(3 "Hannum Clock") lab(4 "Levine Clock")
...
*/	
	...
	subtitle(,fcolor(white) lcolor(white) size(medium))	
	name(F2SF2, replace) 
; #delimit cr
		

//****************************************************************************************//
graph export "/Users/$user/Box/Belsky/mPoA/eLife/Figures/F2SF2.pdf", replace	
//****************************************************************************************//
//****************************************************************************************//
